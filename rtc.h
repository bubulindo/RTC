...
class InternalRTC {
	...
	public: 
		//constructor //overload it with a pointer to the struct
		InternalRTC(unsigned char Seconds, unsigned char Minutes, unsigned char Hours,
